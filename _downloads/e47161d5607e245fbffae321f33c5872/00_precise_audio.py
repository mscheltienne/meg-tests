...
In both cases, the sound comes from the :ref:`stimulation PC <stim-pc:Stimulation PC>`
and is delivered through the `Crimson 3`_, a USB-audio interface (recognized as a sound
card by the :ref:`stimulation PC <stim-pc:Stimulation PC>`).
