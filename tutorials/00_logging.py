...
#%%
# The logger and its utilities can be imported from the ``meg_wiki`` package
# namespace.
...
from meg_wiki import add_file_handler, logger, set_log_level
...
#%%
# The function `~meg_wiki.set_log_level` can be used to edit the level of the
# logger.
...
# changed with `~meg_wiki.set_log_level`.
# Additional file handlers can be added with `~meg_wiki.add_file_handler`.
