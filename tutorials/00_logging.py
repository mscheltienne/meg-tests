...
#%%
# The logger and its utilities can be imported from the ``meg_info`` package
# namespace.
...
from meg_info import add_file_handler, logger, set_log_level
...
#%%
# The function `~meg_info.set_log_level` can be used to edit the level of the
# logger.
...
# changed with `~meg_info.set_log_level`.
# Additional file handlers can be added with `~meg_info.add_file_handler`.
